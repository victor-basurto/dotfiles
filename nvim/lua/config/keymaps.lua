...
-------------------------------------------------------
--     Print Current Directory and Date UTILS
-------------------------------------------------------
wk.add({
  mode = { "n", "v" },
...
-- print relative path
keymap.set("n", "<leader>mpr", utils.copy_relative_path, { desc = "[Dir] Copy current file relative path" })
-- print current file name
keymap.set("n", "<leader>mpf", utils.copy_file_name, { desc = "[Dir] Copy current file name" })
-- print current date
keymap.set("n", "<leader>mpD", utils.copy_current_date, { desc = "[Date] Print current date" })
-------------------------------------------------------
--                  NeoGen
-------------------------------------------------------
...
wk.add({
  ...
  -- obsidian
  { "<leader>mo", desc = "[o]bsidian" }, -- naming
...
end, { desc = "[1] fold headings level 1 or above" })
keymap.set("n", "<leader>mf2", function()
  md_utils.fold_headings_cmd({ 6, 5, 4, 3, 2 })
end, { desc = "[2] fold headings level 2 or above" })
keymap.set("n", "<leader>mf3", function()
  md_utils.fold_headings_cmd({ 6, 5, 4, 3 })
end, { desc = "[3] fold headings level 3 or above" })
keymap.set("n", "<leader>mf4", function()
  md_utils.fold_headings_cmd({ 6, 5, 4 })
end, { desc = "[4] fold headings level 4 or above" })
keymap.set("n", "<leader>mfu", md_utils.unfold_all, { desc = "[u]nfold all headings" })
keymap.set("n", "<leader>mff", md_utils.fold_current_heading, { desc = "[f]old the heading cursor currently on" })
keymap.set("n", "<leader>mft", md_utils.toggle_fold, { desc = "[t]oggle fold" })
...
keymap.set("n", "<leader>mrt", "<cmd>MarkdownPreviewToggle<CR>", { desc = "[t]oggle preview in browser" })
-- strikethrough
keymap.set("n", "<leader>mts", md_utils.toggle_strikethrough, { desc = "[s]trikethrough" })
-- Use <CR> to fold when in normal mode
-- To see help about folds use `:help fold`
keymap.set("n", "<CR>", md_utils.toggle_fold_cr, { desc = "[P]Toggle fold" })
-- Markdown, adds dashes to headings
keymap.set(
  "n",
  "<leader>mthd",
  md_utils.dashes_to_heading,
  { noremap = true, silent = true, desc = "[d]ashes to heading" }
)
